...
#Preview {
    PlayerCardView(player: Player(name: "John", surname: "Doe", weight: 65, height: 175, preferredFoot: "Right", agility: "High", endurance: "Medium", speed: "High", strength: "Medium", verticalJump: "High", role: "Defender", assists: 3, goals: 0, woodworks: 4, presence: 5))
}
